...
<head>
	...
	<title>Restyled | Opret konto</title>
</head>
<body>
				...
				<div class="col-md-12">
					<div class="card bg-section text-white">
						<div class="card-header">
							<h3 class="card-title">Opret konto</h3>
						</div>
						<div class="card-body register">
							<form action="registerfunc.php" method="post">
                                ...
                                <div class="form-group" style="margin-bottom: 10px;">
									<label for="confirm_password">Gentag adgangskode</label>
									<input class="form-control dou-input" type="password" name="confirm_password" class="form-control" id="confirm_password" placeholder="Adgangskode" required>
								</div>
								<button type="submit" class="btn btn-primary">Opret konto</button>
								<a class="login-text" href="login.php">Login her</a>
							</form>
						</div>
					</div>
				</div>
	...
	<script>
        document.querySelector(".register form").onsubmit = function(event) {
            ...
            xhr.open("POST", document.querySelector(".register form").action, true);
            xhr.onload = function () {
